...
INSERT INTO `produits` VALUES (1,'Pavé de saumon','Un bon pavé de saumon','saumon.jpg',6.5,52,1,3,11),(2,'Salade batavia','Salade très bonne','saladeBatavia.jpg',2.5,213,1,2,2),(3,'salade la romaine ','Une autre bonne salade','saladeLaRomaine.jpg',1.8,82,1,2,2),(4,'Banane','De bonne banane de la région','banane.jpg',5.2,56,1,2,12);
...
CREATE TABLE `rayons` (
  ...
  `rayonDesc` varchar(50) DEFAULT NULL,
  `rayonImg` varchar(50) DEFAULT NULL,
  `rayonValid` int(11) DEFAULT NULL,
  PRIMARY KEY (`rayonId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `rayons` VALUES (1,'Cigarette','vente de cigarette et autres','cigarette.jpg',0),(2,'Briquet','','briquet.jpg',0),(3,'Légume','Les bons légumes du jardin','legumes.jpg',0),(4,'Fruits','Les bons fruits de saisons','fruits.jpg',0),(5,'Boucherie','Vente de viande et charcuterie',NULL,1),(6,'Poissonerie','Vente de poissons',NULL,1);
...
INSERT INTO `typeProduit` VALUES (1,'pomme de terre',3),(2,'létue',3),(3,'fraise',4),(5,'tabac à rouler',1),(6,'Gaz',2),(7,'Electrique',2),(8,'Porc',5),(9,'Mouton',5),(10,'Filet',6),(11,'Pavé',6),(12,'banane',4);
...
INSERT INTO `utilisateur` VALUES (1,'AUTHEMAN','Victor','authirard.victor@gmail.com',NULL,'0649259506','ij4udh1A*',1,'2019-10-17','5654623215213',1),(2,'BREGEARD','Rémi','remib@gmail.com','0612345678','0612345678','ij4udh1A*',2,'2019-11-14','1245488764',1),(3,'COMITI','Léo','comiti.leo@yahoo.fr','0612345678','0612345678','ij4udh1A*',3,'2019-11-05','2359877412456',1),(4,'LE PIVERT','Julie','lpjulie@gmail.com','0612345678','0612345678','ij4udh1A*',4,'2019-11-06','2359856451',1),(5,'GRANIER','Nicolas','pandalas@gmail.com','0612345678','0612345678','ij4udh1A*',4,'2019-11-14','1597624876',1);
