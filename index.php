  ...
  <body>
    ...
    <main role="main">
      ...
      <section class="jumbotron text-center">
        <div class="container">
          <h1 class="jumbotron-heading"><span class="text-success">NEWWORLD</span>STORE</h1>
          ...
          <p>
            <a href="#" class="btn btn-primary my-2">Sign in</a>
            <a href="#" class="btn btn-secondary my-2">I am already signed up</a>
          </p>
        </div>
      </section>
        ...
        <div class="container">
          ...
          <div class="row">
            <div class="d-flex flex-row flex-wrap justify-content-between">
              <?php
              $req = $bdd->prepare("SELECT * FROM produits LIMIT 10");
              $req->execute();
              while($cur = $req->fetch())
              {
              ?>
