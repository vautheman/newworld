...
if(!isset($_SESSION['userId']) and isset($_GET['produitId']))
{
  ...
  $reqProduit = $bdd->prepare("SELECT * from produits where produitId = ?");
  $reqProduit->execute(array($_GET['produitId']));
  $curProduit = $reqProduit->fetch();
?>
      ...
      <form class="form" method="post" enctype="multipart/form-data">
        <div class="row">
          <div class="col">
            ...
            <input type="text" id="addProductName" class="form-control" name="addProductName" placeholder="Insert product name ..." value="<?php echo $curProduit['produitLib']; ?>">
          </div>
          <div class="col">
        ...
        <div class="row">
          <div class="col mt-4">
            ...
            <textarea style="height: 200px;" type="text" id="addProductDesc" class="form-control" name="addProductDesc" placeholder="Insert product description ..."><?php echo $curProduit['produitDesc']; ?></textarea>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col mt-4">
            ...
            <input type="number" id="addProductPU" name="addProductPU" class="form-control" value="<?php echo $curProduit['produitPU']; ?>">
          </div>
          <div class="col mt-4">
            <label style="font-size: 14pt;" class="" for="addProductStock">Number of products in stock :</label>
            <input type="number" id="addProductStock" name="addProductStock" class="form-control" value="<?php echo $curProduit['produitQuantite']; ?>">
          </div>
        </div>

        <input type="submit" class="w-100 btn btn-info mt-5 p-2" name="" value="Update" style="font-size: 16pt; text-transform: uppercase;">
      </form>
