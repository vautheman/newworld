...
function rejoindre()
{
  ...
  if(check1==false)
  {
    btnRejoindre.style.background="#f1f1f2";
    btnRejoindre.style.color="#939C9E";
    btnRejoindre.style.cursor="default";
    btnRejoindre.fontcolor("red");
  }
  else {
    btnRejoindre.style.background="#00b0b9";
    btnRejoindre.style.color="#ffffff";
    btnRejoindre.style.cursor="pointer";
  }
}
