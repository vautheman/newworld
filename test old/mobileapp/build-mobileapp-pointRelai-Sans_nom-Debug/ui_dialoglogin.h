...
public:
    ...
    void retranslateUi(QDialog *DialogLogin)
    {
        ...
        pushButton_connect->setText(QApplication::translate("DialogLogin", "connection", nullptr));
        lineEdit_user->setPlaceholderText(QApplication::translate("DialogLogin", "user", nullptr));
        lineEdit_pwd->setPlaceholderText(QApplication::translate("DialogLogin", "password", nullptr));
    } // retranslateUi
